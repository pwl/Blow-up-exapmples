...
echo "set output \"graphics/Passing_through_the_blow_up_slow_time.ps\"" >> plotter.gp
...
ps2pdf graphics/Passing_through_the_blow_up_slow_time.ps graphics/Passing_through_the_blow_up_slow_time.pdf
evince graphics/Passing_through_the_blow_up_slow_time.ps
